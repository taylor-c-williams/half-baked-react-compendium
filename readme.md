...
| Tasks                                                                               | Points                                                  |
| ----------------------------------------------------------------------------------- | ------------------------------------------------------- | --- |
| Stop the 1 `useEffect` hook from running infinitely ✔︎                              | 2                                                       |
| Fix the 2 function calls not being awaited ✔︎                                       | 2                                                       |
| Fix the subtle error with the 1 `useEffect` call                                    | 1                                                       |
| Find 1 component that is rendering elements with a `key` missing and add a `key` ✔︎ | 2                                                       |
|                                                                                     | Find the 3 places state is being updated incorrectly ✔︎ | 2   |
